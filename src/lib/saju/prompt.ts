...
각 섹션은 반드시 2000자 이상 작성한다. 내용이 부족하면 추가 분석을 덧붙여서라도 2000자를 채운다.
이름은 첫 번째 섹션 시작 부분에 딱 한 번만 자연스럽게 언급하고, 이후에는 절대 사용하지 않는다.

## 섹션 1: 나의 사주 핵심 성향 (2000자 이상 필수)
...
## 섹션 2: ${input.currentYear}년 병오년 총운 (2000자 이상 필수)
...
각 월마다 700~900자 분량으로 충실하게 작성한다. 이름은 절대 사용하지 않는다.
6개월 모두 빠짐없이 작성해야 하며, 한 달도 생략하거나 축약하지 않는다.
