      ...
      <section className="relative overflow-hidden" style={{ background: '#060309' }}>
        ...
        <div className="relative z-10 px-6 pt-14 pb-10 max-w-md mx-auto">
          ...
          <div className="text-center mb-8">
            ...
            <div className="inline-flex items-center gap-1.5 rounded-full px-5 py-2 text-sm font-black" style={{ background: 'linear-gradient(90deg,#a21caf,#e879f9)', color: 'white', boxShadow: '0 6px 28px rgba(232,121,249,0.4)' }}>지금 결제 시 44% 할인!</div>
          </div>
          <div className="text-center mb-8">
