...
const PRODUCTS = [
  {
    ...
    description: '2026년 병오(丙午)년의 기운이 나의 사주와 어떻게 맞물리는지 정통 명리학으로 완전히 해석합니다. 어떤 달에 기회가 찾아오고, 어떤 시기를 조심해야 하는지 월별로 상세히 풀어드립니다.',
    ...
    discoveries: [
      '2026년 나의 전체적인 운기 흐름',
      '기회가 찾아오는 달 vs 조심해야 할 달',
      '올해 재물·직업·건강·연애운 종합',
      '10년 대운과 올해의 연관성',
      '2026년 가장 좋은 결정 타이밍',
    ],
    previewItems: ['1월 – 새로운 인연의 씨앗이 심어지는 달', '2월 – 재물운 상승, 투자보다 저축 유리', '3월 – ⚠️ 건강 주의, 과로 조심'],
    recommend: [
